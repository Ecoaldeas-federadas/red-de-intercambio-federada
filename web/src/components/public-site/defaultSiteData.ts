...
export const FERIA_CONUQUERA_TEMPLATES: PreconfiguredPageTemplate[] = [
  {
    slug: 'inicio',
    title: 'Inicio',
    subtitle: 'Bienvenida a la Feria Conuquera Agroecológica',
    icon: 'home',
    menu_order: 1,
    blocks: [
      {
        ...
        description:
          'Un espacio autogestionado de encuentro popular, economía solidaria y trueque en las faldas del Parque Los Caobos. Conectamos directamente a familias campesinas y conuqueras con los habitantes de Caracas, sin intermediarios, especulación ni agrotóxicos.',
        image_url:
        ...
        items: [
          {
            ...
            description:
              'El conuco como laboratorio de vida integral frente a la lógica destructiva del monocultivo y el agronegocio transnacional.',
            badge: 'Suelo Vivo',
          },
          {
            icon: 'users',
            ...
            description:
              'Relación fraterna entre quien siembra y quien consume, eliminando intermediarios usureros y especulación.',
          ...
          },
          {
            ...
            description:
              'Sistema contable de suma cero respaldado en valor energético (1 TQ = 1 kWh) y confianza comunitaria, sin intereses bancarios.',
            badge: 'Moneda Social',
          },
          {
            icon: 'heart',
            ...
            description:
              'Defensa irrestricta de la Ley de Semillas de Venezuela: protección de variedades criollas frente a semillas transgénicas patentadas.',
            badge: 'Biodiversidad',
          },
          {
            icon: 'shopping-cart',
            ...
            description:
              'Rescate de recetas patrimoniales como la cafunga de Barlovento, harinas ancestrales, fermentos y medicina botánica.',
          ...
          },
          {
            ...
            description:
              'Articulación con el Proyecto Campo Soberano para el desarrollo de hábitats rurales de ciclo cerrado y soberanía integral.',
            badge: 'Permacultura',
          },
        ],
      },
      {
        ...
        subtitle:
          'Súmate a la red comunitaria. La asamblea evalúa solicitudes de familias productoras, colectivos y vecinos que deseen integrarse al sistema de intercambio solidario.',
    ...
    blocks: [
      {
        ...
        description:
          'Nacimos en un momento crucial de la historia agrícola nacional, al calor de los intensos debates populares organizados por el Movimiento Semillas del Pueblo para la construcción colectiva de la Ley de Semillas de Venezuela.',
        image_url:
        ...
        items: [
          {
            ...
            quote:
              'Comenzamos sembrando en las faldas de El Ávila para demostrar que la montaña puede alimentar a Caracas con dignidad y amor a la naturaleza.',
          ...
          },
          {
            ...
            quote:
              'Empecé a investigar y formular cosmética y medicina natural para el cuidado de mi hijo con discapacidad. Hoy es nuestro aporte para la salud comunitaria.',
            location: 'Caracas',
          },
          {
            ...
            quote:
              'Llevamos 10 años ininterrumpidos en Los Caobos trayendo acelgas, col rizada, queso de cabra y tubérculos 100% agroecológicos.',
          ...
          },
          {
            ...
            quote:
              'Formamos a cientos de jóvenes y vecinos en lombricultura, compostaje y bioinsumos para llenar de huertos urbanos toda la ciudad.',
    ...
    blocks: [
      {
        ...
        description:
          'Encuentra hortalizas frescas de temporada, semillas ancestrales, tubérculos autóctonos, derivados lácteos artesanales, botica conuquera, cosmética natural y delicias gastronómicas tradicionales preparadas por maestros artesanos.',
        image_url:
        ...
        items: [
          {
            ...
            description:
              'Col rizada (kale portuguesa), acelgas, lechugas variadas, cebollín, cilantro de monte y apio España cosechados el mismo día.',
          ...
          },
          {
            ...
            category: 'Medicina Botánica & Cosmética',
            description:
              'Desodorantes ecológicos de aceite de coco y bicarbonato, bálsamos labiales de cera de abeja, jabones artesanales y toallas ecológicas reutilizables.',
            badge: 'Residuo Cero',
            image_url:
          ...
          },
          {
            ...
            category: 'Gastronomía Artesanal',
            description:
              'Quesos madurados y frescos, dulce de leche de cabra, yogurt natural y mantequilla artesanal de pequeños rebaños pastoreados.',
    ...
    blocks: [
      {
        ...
        description:
          'Inspirados en la metodología "de campesino a campesino", cada jornada en Parque Los Caobos cuenta con actividades pedagógicas gratuitas para compartir conocimientos de lombricultura, salud botánica, fermentos y agroecología.',
        image_url:
        ...
        items: [
          {
            ...
            description:
              'Mesa comunitaria para entregar y recibir semillas libres de patentes. Protegemos nuestra agrobiodiversidad compartiendo variedades locales.',
          ...
          },
          {
            ...
            description:
              'Punto de intercambio de novelas, manuales agrícolas, textos de ecología y poesía. Llévate un libro con la promesa de seguir compartiendo el saber.',
            badge: 'Lectura Libre',
          },
          {
            icon: 'users',
            ...
            description:
              'Talleres prácticos: elaboración de kokedamas, preparación de sustratos con fibra de coco, extractos botánicos y crianza de lombrices.',
    ...
    blocks: [
      {
        ...
        description:
          'El trueque no es dinero emitido por un banco ni se compra ni se vende. Es un registro transparente de compromisos entre miembros de la comunidad que permite el intercambio de bienes, trabajo y saberes sin intermediación financiera.',
        image_url:
        ...
        steps: [
          {
            ...
            description:
              'Al unirte a la red, tu cuenta inicia en balance 0. No necesitas comprar monedas ni aportar capital para participar.',
            icon: 'users',
          },
          {
            step: 2,
            ...
            description:
              'Tu cuenta registra saldo negativo (ej: -50 TQ). No es una deuda bancaria usurera: es un compromiso de entregar productos o trabajo futuro a la comunidad.',
            icon: 'shopping-cart',
          },
          {
            step: 3,
            ...
            description:
              'Tu cuenta registra saldo positivo (ej: +50 TQ). Significa que has entregado valor a la comunidad y tienes derecho a adquirir bienes de otros miembros.',
            icon: 'leaf',
          },
          {
            step: 4,
            ...
            description:
              'La suma de todas las cuentas de la red da exactamente 0 TQ. No existe inflación, devaluación ni emisión descontrolada.',
            icon: 'scale',
          },
        ],
        key_points: {
          positive_balance:
            'Indica que has aportado más de lo que has consumido. Puedes canjearlo por bienes de cualquier otro miembro de la red.',
          negative_balance:
            'Es un saldo deudor ético: has recibido sustento y lo retribuirás con tu propia producción o servicios. Existen topes definidos por la asamblea.',
          zero_sum:
            'Nadie lucra con la emisión. No hay tasas de interés sobre el ahorro ni penalizaciones financieras sobre el saldo negativo.',
        },
      },
      {
        type: 'faq',
        ...
        items: [
          {
            ...
            answer:
              'Porque la energía es una medida objetiva y física del esfuerzo humano, de los insumos y de las herramientas utilizadas para producir cualquier bien, protegiendo a la comunidad de la especulación monetaria.',
          },
          {
            question: '¿Qué evita que alguien acumule o gaste sin límite?',
            answer:
              'La asamblea establece límites máximos de crédito (tope positivo) y límites de débito (tope negativo) según el nivel de cada miembro u organización.',
          },
          {
            question: '¿Qué pasa si un miembro decide retirarse de la red?',
            answer:
              'Si su saldo es cero, se retira sin obligaciones. Si tiene saldo negativo, debe compensar entregando bienes o trabajo. Si tiene saldo positivo, puede consumir su balance antes de salir.',
          },
        ],
      },
    ],
        ...
        items: [
          {
            ...
            answer:
              'Se celebra el primer sábado de cada mes en el Parque Los Caobos de Caracas (zona sur, cerca del estacionamiento y la Fuente Venezuela), desde las 9:00 AM hasta la 1:00 PM aproximadamente.',
          },
          {
            question: '¿Cómo llegar en transporte público?',
            answer:
              'Puedes llegar en Metro de Caracas bajándote en la estación Bellas Artes o Colegio de Ingenieros. Desde allí caminas 5 minutos hacia el Parque Los Caobos.',
          },
          {
            question: '¿Por qué no se permiten bolsas plásticas desechables?',
            answer:
              'Porque la agroecología es un compromiso integral con la vida. El plástico contamina ríos y suelos. Te invitamos a traer bolsas de tela, morrales, recipientes o canastas reutilizables.',
          },
          {
            question: 'Soy productor agroecológico y quiero participar, ¿qué debo hacer?',
            answer:
              'Debes llenar el formulario de solicitud de admisión en esta plataforma. La asamblea conuquera evalúa que la producción sea 100% agroecológica (sin agrotóxicos) y coordina una visita formativa.',
          },
          {
            question: '¿Se puede pagar con moneda convencional o solo trueque?',
            answer:
              'Se promueve activamente el trueque directo y el sistema de crédito mutuo (Trueque TQ), pero los visitantes que aún no tienen cuenta pueden coordinar intercambios o adquirir productos con aportes solidarios directos a los productores.',
          },
          {
            question: '¿Tienen actividades para niños y familias?',
            answer:
              '¡Sí! Cada edición incluye títeres, trueque de libros infantiles, talleres de siembra para niños y música popular venezolana al aire libre.',
          },
        ],
      },
    ],
    ...
    blocks: [
      {
        ...
        transport_info:
          'Estación Metro Bellas Artes (Línea 1) o Colegio de Ingenieros. Acceso vehicular por la avenida México y Plaza Venezuela.',
      },
      {
        type: 'cta_banner',
