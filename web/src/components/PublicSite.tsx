...
export function PublicJoinForm() {
  ...
  if (submitted) {
    return (
      <div className="bg-white rounded-3xl p-6 sm:p-12 text-center max-w-2xl mx-auto shadow-md border border-emerald-100 space-y-3 my-6">
        ...
        <div className="pt-3">
          <Link
            to="/p/inicio"
            className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-xl font-bold text-white bg-trueque-700 hover:bg-trueque-800 transition text-xs shadow"
          >
  ...
  return (
    <div className="max-w-2xl mx-auto my-4 sm:my-6 space-y-5">
      <div className="text-center space-y-1.5">
        <span className="inline-block px-3 py-0.5 rounded-full text-[11px] font-bold bg-amber-100 text-amber-900">
      ...
      <div className="bg-white rounded-3xl p-5 sm:p-8 shadow-sm border border-gray-200 space-y-4">
        {error && (
        ...
        <div>
          <label className="label font-bold text-xs text-gray-800">Nombre Completo *</label>
          <input
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          <div>
            <label className="label font-bold text-xs text-gray-800">Correo Electrónico</label>
            <input
              type="email"
              className="input text-sm"
          ...
          <div>
            <label className="label font-bold text-xs text-gray-800">Teléfono / WhatsApp</label>
            <input
              className="input text-sm"
        ...
        <div>
          <label className="label font-bold text-xs text-gray-800">Ubicación / Sector donde produces o vives</label>
          <input
            className="input text-sm"
        ...
        <div>
          <label className="label font-bold text-xs text-gray-800">¿Qué produces o qué saberes deseas aportar?</label>
          <textarea
            rows={3}
            className="input text-sm"
        ...
        <div>
          <label className="label font-bold text-xs text-gray-800">¿Por qué deseas unirte a la red de trueque?</label>
          <textarea
            rows={3}
            className="input text-sm"
        ...
        <div>
          <label className="label font-bold text-xs text-gray-800">¿Cómo te enteraste de la feria?</label>
          <input
            className="input text-sm"
        ...
        <div className="pt-2">
          <button
            onClick={submit}
            disabled={loading}
            className="w-full py-3 rounded-xl font-bold text-white bg-trueque-800 hover:bg-trueque-700 active:scale-95 transition shadow-md text-sm disabled:opacity-50 flex items-center justify-center gap-2"
          >
