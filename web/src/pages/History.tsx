    ...
    <div className="space-y-4">
      ...
      {showHelp && (
        <div className="card bg-blue-50 border-blue-200 text-sm text-gray-700 space-y-3">
          ...
          <p><strong>Que muestra:</strong> {t('history.help_what', `El historial es el registro completo de todas las transacciones en las que has participado, ya sea como remitente (quien envia) o como destinatario (quien recibe). Incluye transferencias entre usuarios, pagos y cualquier otro movimiento de Trueques (${currency}) de tu cuenta.`, { currency })}</p>
          <p><strong>Para que sirve:</strong> {t('history.help_purpose', 'Para llevar el control de tus movimientos, verificar quien te ha enviado o a quien le has enviado Trueques, revisar los motivos de cada transaccion y auditar que todo cuadre con tus expectativas. Es tu libro de cuentas personal dentro de la red.')}</p>
          <p><strong>Como se usa:</strong> {t('history.help_usage', 'Al entrar a la pagina se carga automaticamente la lista de tus transacciones mas recientes. Cada fila es una transaccion. Si no aparece nada, significa que todavia no has realizado ni recibido transferencias.')}</p>
