    ...
    <div className="space-y-4">
      ...
      <div className="card bg-blue-50 p-3 text-sm text-blue-700 flex items-start gap-2">
        ...
        <div>
          ...
          <br /><br />
          <strong>Por defecto se requiere el 75% de los nodos</strong> (mayia debe aprobar).
          Este umbral se puede cambiar, pero para cambiarlo se necesita la aprobacion bajo el umbral actual.
          Es decir: si el umbral actual es 75%, cambiarlo a 100% o 50%+1 requiere que se apruebe bajo el 75%.
          Una vez cambiado, las futuras propuestas se aprueban con el nuevo umbral.
          <br /><br />
          Cuando hay un solo nodo, sus propuestas se auto-aprueban (es el 100% de 1 nodo).
        ...
        <div className="space-y-4">
          <div className="card bg-red-50 p-3 text-sm text-red-700 flex items-start gap-2">
            ...
            <div>
              ...
              Se crea una propuesta de expulsion que los nodos deben aprobar
              (bajo el umbral actual, por defecto 75%).
