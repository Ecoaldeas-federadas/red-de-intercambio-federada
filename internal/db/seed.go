...
func (d *DB) SeedProductsToNode(ctx context.Context, nodeDomain string) error {
	...
	products := []struct {
		...
		// ============ ALIMENTOS: Canasta Basica ============
		{"Canasta Basica Familiar Semanal", "Alimentacion", "Canasta Basica", "Semanal", "canasta",
			"Canasta semanal para familia 4-5 personas: 3kg granos, 2kg verduras, 1kg frutas, 0.5kg carne, 1L leche, 0.5L aceite, 0.5kg azucar, 1 docena huevos, especias. Energia total: ~50 kWh/semana.", "Necesidad Vital",
			"https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=600&q=80", 50, 0, 0, 50, 0},
		...
		{"Sistemas de Riego", "Agricultura", "Riego", "Sistemas", "juego",
			"Mangueras, aspersores, goteros, bombas manuales, tanques. Energia: PVC + componentes ~50 kWh/juego.", "Riego Eficiente",
			"https://images.unsplash.com/photo-1576045057995-568f588f82fb?auto=format&fit=crop&w=600&q=80", 50, 0, 0, 50, 0},
		...
		{"Botiquin y Primeros Auxilios", "Salud y Medicina", "Primeros Auxilios", "Botiquin", "juego",
			"Vendas, gasas, alcohol, yodo, apositos, tiritas, tijeras, manual. Energia: ~18 MJ/juego = 5 kWh.", "Emergencia",
			"https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?auto=format&fit=crop&w=600&q=80", 5, 0, 0, 5, 0},

		// ============ TEXTILES ============
		{"Prendas de Vestir Artesanales", "Textiles", "Confeccion", "Prendas", "unidad",
			"Camisas, pantalones, vestidos, faldas, blusas de algodon o lana. Energia: ~108 MJ/unidad = 30 kWh (tela + confeccion + tintes). Fuente: Ecoinvent.", "Hecho a Mano",
			"https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=600&q=80", 30, 0, 0, 30, 0},
		...
		{"Telas Naturales", "Textiles", "Tejidos", "Telas", "m",
			"Tela de algodon, lino, lana, ca̱amo, cruda, te̱ida natural. Energia: ~30 MJ/m = 8 kWh/m (cultivo + hilado + tejido). Fuente: Ecoinvent.", "Natural",
			"https://images.unsplash.com/photo-1605000797499-95a51c5269ae?auto=format&fit=crop&w=600&q=80", 8, 0, 0, 8, 0},
		{"Cobijas, Frazadas y Hamacas", "Textiles", "Tejidos", "Cobijas", "unidad",
			"Frazadas de lana, mantas de algodon, hamacas de ca̱amo, colchas. Energia: ~144 MJ/unidad = 40 kWh.", "Calor Artesanal",
		...
		{"Hilos y Lana para Tejer", "Textiles", "Hilos y Materiales", "Hilos", "rollo",
			"Hilo de coser, lana para tejer, ca̱amo, estambres, hilos encerados. Energia: ~18 MJ/rollo = 5 kWh.", "Materia Prima",
			"https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=600&q=80", 5, 0, 0, 5, 0},

		// ============ ARTESANIA ============
		{"Vasijas y Vajilla de Barro", "Artesania", "Ceramica", "Vasijas", "unidad",
			"Ollas de barro, vasijas, platos, tazas, cantaras, budares. Energia: ~54 MJ/unidad = 15 kWh (extraccion + coccion horno).", "Barro Artesanal",
		...
		{"Ceramica Decorativa", "Artesania", "Ceramica", "Decoracion", "unidad",
			"Figuras, adornos, macetas decorativas, joyeros de arcilla. Energia: ~54 MJ/unidad = 15 kWh.", "Hecho a Mano",
			"https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?auto=format&fit=crop&w=600&q=80", 15, 15, 0, 0, 0},
		{"Canastas y Cesteria", "Artesania", "Cesteria", "Canastas", "unidad",
			"Canastos, cestas, petacas, cajas de fibra vegetal, sombreros de paja. Energia: ~36 MJ/unidad = 10 kWh (recoleccion + tejido manual).", "Fibra Vegetal",
			"https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?auto=format&fit=crop&w=600&q=80", 10, 10, 0, 0, 0},
		{"Tallados y Utensilios de Madera", "Artesania", "Madera", "Tallados", "unidad",
			"Cucharas de palo, morteros, pilones, tallas decorativas, juguetes. Energia: ~72 MJ/unidad = 20 kWh (madera + tallado).", "Madera Noble",
			"https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?auto=format&fit=crop&w=600&q=80", 20, 20, 0, 0, 0},
		{"Muebles Rusticos de Madera", "Artesania", "Madera", "Muebles", "unidad",
			"Mesas, sillas, bancos, camas, estantes de madera local. Energia: ~288 MJ/unidad = 80 kWh (madera 3 kWh/kg + ebanisteria).", "Muebleria Artesanal",
			"https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?auto=format&fit=crop&w=600&q=80", 80, 0, 0, 80, 0},
		...
		{"Herramientas de Campo", "Herramientas", "Manuales", "Agricolas", "unidad",
			"Machetes, palas, picos, rastrillos, azadones. Energia: acero 6 kWh/kg + manufactura ~50 kWh/unidad.", "Trabajo Duro",
			"https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=600&q=80", 50, 0, 0, 50, 0},
		{"Herramientas de Taller", "Herramientas", "Manuales", "Taller", "unidad",
			"Martillos, serruchos, limas, destornilladores, alicates. Energia: acero + manufactura ~50 kWh/unidad.", "Taller",
			"https://images.unsplash.com/photo-1632823469850-1e6a3d1c14e1?auto=format&fit=crop&w=600&q=80", 50, 0, 0, 50, 0},
		...
		{"Equipos Electricos de Taller", "Herramientas", "Electricas", "Equipos", "unidad",
			"Taladros, sierras circulares, amoladoras, lijadoras, soldadoras. Energia: acero + motor + electronicos ~200 kWh/unidad.", "Electrico",
		...
		{"Componentes Electronicos", "Tecnologia", "Componentes", "Piezas", "lote",
			"Resistencias, capacitores, cables, conectores, soldadura, plaquetas, fusibles. Energia: ~36 MJ/lote = 10 kWh.", "Electronica",
			"https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=600&q=80", 10, 0, 0, 10, 0},

		// ============ TRANSPORTE ============
		{"Bicicletas y Refacciones", "Transporte", "Vehiculos", "Bicicletas", "unidad",
			"Bicicleta completa. Energia: acero 6 kWh/kg x ~15kg + caucho + ensamblaje ~100 kWh.", "Transporte Limpio",
		...
		{"Animales de Carga y Montura", "Transporte", "Animales", "Equinos", "unidad",
			"Caballos, burros, mulas para carga y montura. Energia: mantenimiento + crianza ~18 kWh/kg de masa.", "Traccion Animal",
			"https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=600&q=80", 18, 0, 0, 18, 0},

		// ============ CULTURA ============
		{"Instrumentos Musicales Artesanales", "Cultura", "Musica", "Instrumentos", "unidad",
			"Tambores, maracas, cuatros, guitarras, marimbas, flautas de cana. Energia: madera + cuero + manufactura ~100 kWh.", "Musica Viva",
			"https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=600&q=80", 100, 0, 0, 100, 0},
