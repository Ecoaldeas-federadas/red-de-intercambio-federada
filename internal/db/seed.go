...
func getSeedPages() []seedPage {
			...
			Content: `[
  {
    ...
    "subtitle": "Un sistema gratuito y configurable que permite a cada ecoaldea gestionar su economía, gobernanza e intercambios, y federarse con otras comunidades en una red de comercio justo, sin inflación y sin intermediarios.",
    "description": "Cada comunidad mantiene su autonomía, sus normas y su gobernanza, pero puede intercambiar con otras comunidades federadas de manera justa.",
    "image_url": "/placeholder.svg",
    "primary_cta": { "text": "Conocer más", "link": "/p/filosofia" },
    "secondary_cta": { "text": "Solicitar Ingreso", "link": "/p/unirse" },
    "style": "split",
    "bg_gradient": true
  },
  {
    ...
    "subtitle": "Imagina lo que Visa y Mastercard hacen por los comercios: agruparlos en una red que permite intercambiar sin fronteras. Ahora imagina eso, pero para ecoaldeas, comunidades autogestionadas y redes de trueque.",
    "columns": 3,
    "items": [
      {"icon":"scale","title":"Gobernanza configurable","description":"Cada comunidad define sus propias normas, asambleas, quórum, niveles de miembro y procesos de admisión."},
      {"icon":"leaf","title":"Economía propia","description":"Moneda comunitaria (TQ) basada en energía (kWh/Joule), no en dinero bancario. Sin inflación, sin interés."},
      {"icon":"network","title":"Federación entre nodos","description":"Intercambia con otras ecoaldeas federadas. Cada nodo respeta las normas internas de los demás."},
      {"icon":"users","title":"Comunidad autogestionada","description":"Organizaciones, departamentos, asambleas, votaciones, admisión de miembros y recuperación de cuentas."},
      {"icon":"globe","title":"Sitio web público","description":"Cada nodo tiene su propio sitio web configurable para mostrar productos, filosofía y contacto."},
      {"icon":"heart","title":"Gratis y abierto","description":"La plataforma es gratuita. Asesoría incluida. Abierta a aportes y mejoras desde la experiencia real."}
    ]
  },
  {
    "type": "richtext",
  ...
  },
  {
    ...
    "content": "<h3>Firma Dual</h3><p>Cada transacción entre nodos debe ser firmada por <strong>AMBOS nodos</strong> con sus claves criptográficas. Una transacción sin ambas firmas <strong>no es válida</strong>.</p><h3>Hash Encadenado</h3><p>Cada transacción incluye el hash de la transacción anterior (como una blockchain simplificada). Si alguien intenta insertar, modificar o eliminar una transacción, la cadena se rompe y se detecta inmediatamente.</p><p><strong>Reconciliación al reconectar:</strong> Cuando un nodo que estaba offline se reconecta, compara los hashes de su cadena con los del otro nodo. Si coinciden, están sincronizados. Si no, intercambian las transacciones divergentes, verifican las firmas y los hashes, e incorporan las válidas.</p>"
  },
  {
    "type": "features_grid",
  ...
  },
  {
    ...
    "items": [
      {"question":"¿Para qué sirve federarse? ¿No es mejor que cada comunidad funcione sola?","answer":"Cada comunidad es autónoma y toma sus propias decisiones internas. Pero federarse tiene ventajas: puedes intercambiar con miembros de otras comunidades, el espectro de lo que puedes aportar y recibir se amplía, y las comunidades se apoyan mutuamente. Una comunidad sola es frágil; una red de comunidades es robusta."},
      {"question":"¿Tengo que aportar algo para entrar a una comunidad federada?","answer":"Sí. Para entrar tienes que tener algo que aportar: productos, trabajo, talentos, servicios, o conocimientos. Si solo quieres recibir pero no tienes nada que aportar, el trueque no te va a funcionar."},
      {"question":"¿Por qué el saldo perfecto es cero?","answer":"Si tu saldo está en cero, significa que has aportado a la comunidad exactamente lo mismo que has recibido de ella. Eso es equilibrio. Si está muy negativo, estás recibiendo mucho pero aportando poco. Si está muy positivo, estás aportando mucho pero no aprovechando lo que la comunidad ofrece."},
      {"question":"¿Puedo usar mi saldo TQ en otra comunidad de la federación?","answer":"Sí. Si vas a otra comunidad federada, puedes usar tu tarjeta NFC o tu cuenta para intercambiar. La federación no crea dinero nuevo, solo amplía el espectro de lo que puedes recibir."},
      {"question":"¿La moneda TQ tiene inflación?","answer":"No. La moneda TQ no tiene inflación porque no está atada al dinero de ningún país ni al oro. Está atada a la energía: 1 TQ = 1 kWh. La energía no se devalúa. Una hora de trabajo hoy vale lo mismo que una hora de trabajo dentro de 10 años."},
      {"question":"¿Mi comunidad tiene que pagar para usar el software?","answer":"No. El software es 100% gratuito y de código abierto. Cualquier comunidad puede instalarlo, usarlo, y adaptarlo sin pagar licencias."},
      {"question":"¿La federación funciona sin internet?","answer":"La federación puede funcionar por Internet público o por intranet comunitaria usando túneles WireGuard. Incluso comunidades sin acceso a Internet pueden federarse si instalan OpenWrt y configuran los túneles."},
      {"question":"¿Quién gobierna la federación?","answer":"La federación se gobierna por votación de todos los nodos federados. Cada comunidad (nodo) tiene un voto. Las decisiones que afectan a toda la federación se toman colectivamente. Ninguna comunidad puede imponer reglas sobre las demás."}
    ]
  },
  {
    "type": "cta_banner",
    ...
    "subtitle": "La plataforma está en pleno desarrollo y queremos que se adapte a las necesidades de cada comunidad. Escríbenos para conversar sobre tu experiencia y ver cómo podemos integrarnos.",
