...
func (d *DB) SeedProductsToNode(ctx context.Context, nodeDomain string) error {
	...
	products := []struct {
		...
		{"Harina de maiz 50kg", "Alimentacion", "Granos y Cereales", "Harinas", "saco",
			...
			"https://images.unsplash.com/photo-1699315529894-402495fddb8b?auto=format&fit=crop&w=600&q=80", 10000, 500, 5000, 2000, 2500},
		...
		{"Miel 1L", "Alimentacion", "Endulzantes", "Miel", "litro",
			"Miel pura de abejas, 1 litro.", "Pura",
		...
		{"Prenda artesanal (lana/algodon)", "Textiles", "Confeccion", "Prendas", "unidad",
			"Prenda artesanal de lana o algodon.", "Hecho a Mano",
		...
		{"Tela de algodon 1m", "Textiles", "Tejidos", "Telas", "m",
			"Tela de algodon, 1 metro.", "Natural",
		...
		{"Hora de labor agricola", "Servicios", "Trabajo Agricola", "Jornales", "hora",
			"Hora de trabajo agricola.", "Conuquero",
