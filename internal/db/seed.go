...
func (d *DB) SeedPublicPages(ctx context.Context, nodeDomain string) error {
  ...
  },
  {
    ...
    "items": [
      ...
      {"icon":"scale","title":"Valor por energía, no por precio","description":"No existe un precio en unidades monetarias. El valor lo determina la energía física invertida en producir cada bien o servicio: horas de trabajo, esfuerzo, insumos, herramientas y amortización. Una hora de trabajo manual equivale aproximadamente a 0.1 kWh.","badge":"Energía objetiva"},
...
func (d *DB) SeedProductsToNode(ctx context.Context, nodeDomain string) error {
	...
	// 2. Catalogo completo de productos y servicios de una comunidad autosustentable
	// Organizado por parent_category > category > subcategory
	// Productos equivalentes agrupados con mismo precio (equivalencia energetica)
	...
	products := []struct {
		...
		{"Hojas Verdes y Aromaticas", "Alimentacion", "Cosecha Fresca", "Hojas Verdes", "manojo",
			"Lechuga, repollo, espinaca, acelga, cilantro, perejil, cebollin, apio, hierbabuena, toronjil.",
			"Fresco del Dia",
		...
		{"Verduras y Hortalizas de Conuco", "Alimentacion", "Cosecha Fresca", "Verduras", "kg",
			"Tomate, pimenton, pepino, berenjena, zanahoria, remolacha, ajo, cebolla, ahuyama, calabacin.",
			"Del Conuco",
			"https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=600&q=80", 50, 0, 0, 0, 0},
		{"Frutas de Temporada", "Alimentacion", "Cosecha Fresca", "Frutas", "kg",
			"Mango, papaya, guayaba, patilla, melon, pina, lechosa, cambur, limon, naranja, mandarina, aguacate.",
			"De Estacion",
			"https://images.unsplash.com/photo-1619566636856-adf8ab172aa0?auto=format&fit=crop&w=600&q=80", 60, 0, 0, 0, 0},
		{"Raices y Bulbos", "Alimentacion", "Cosecha Fresca", "Raices", "kg",
			"Apio, name topi, mapuey, batata, borugo, rabano.",
			"Raices Criollas",
			"https://images.unsplash.com/photo-1578269830911-6159f1aee3b4?auto=format&fit=crop&w=600&q=80", 65, 0, 0, 0, 0},
		// --- Gastronomia Artesanal ---
		{"Dulces y Conservas Tradicionales", "Alimentacion", "Gastronomia Artesanal", "Dulces Tradicionales", "kg",
			"Cafunga de Barlovento, dulce de lechosa, cabello de angel, jalea de guayaba, conservas de coco, bocadillo.",
			"Plato Patrimonial",
			"https://images.unsplash.com/photo-1555939594-58d7cb561ad1?auto=format&fit=crop&w=600&q=80", 200, 0, 0, 0, 0},
		{"Lacteos Artesanales", "Alimentacion", "Gastronomia Artesanal", "Lacteos", "kg",
			"Queso fresco, queso de mano, queso guayanes, suero, cuajada, dulce de leche, yogurt natural, mantequilla.",
			"Pastoreo Libre",
			"https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?auto=format&fit=crop&w=600&q=80", 300, 0, 0, 0, 0},
		{"Cacao, Chocolate y Cafe", "Alimentacion", "Gastronomia Artesanal", "Cacao y Cafe", "kg",
			"Cacao fermentado de Barlovento y Chuao, chocolate bean-to-bar 70%, cafe lavado tostado a lena.",
			"Origen Venezolano",
			"https://images.unsplash.com/photo-1549007994-cb92caebd54b?auto=format&fit=crop&w=600&q=80", 2500, 0, 0, 0, 0},
		{"Panaderia y Masas Caseras", "Alimentacion", "Gastronomia Artesanal", "Panaderia", "kg",
			"Pan de maiz, pan de trigo integral, arepas, cachapas, bollos, empanadas, tortillas de maiz.",
			"Hecho en Casa",
			"https://images.unsplash.com/photo-1509444154694-2c20049b1c1e?auto=format&fit=crop&w=600&q=80", 150, 0, 0, 0, 0},
		{"Encurtidos y Salsas", "Alimentacion", "Gastronomia Artesanal", "Conservas", "frasco",
			"Encurtidos de vegetales, tomate enlatado, salsa picante, guasacaca, pesto de albahaca.",
			"Conserva Viva",
			"https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=600&q=80", 180, 0, 0, 0, 0},
		// --- Granos y Cereales ---
		{"Granos Basicos Criollos", "Alimentacion", "Granos y Cereales", "Granos", "kg",
			"Maiz criollo blanco y amarillo, frijol, caraota, quinchoncho, lentejas, garbanzos, habas.",
			"Criollo",
			"https://images.unsplash.com/photo-1765144815957-6bc44c13fc2c?auto=format&fit=crop&w=600&q=80", 90, 10, 60, 15, 5},
		{"Harinas Integrales", "Alimentacion", "Granos y Cereales", "Harinas", "kg",
			"Harina de maiz, harina de trigo integral, harina de yuca (casabe), harina de platanos, harina de quinoa.",
			"Base Criolla",
			"https://images.unsplash.com/photo-1699315529894-402495fddb8b?auto=format&fit=crop&w=600&q=80", 200, 0, 0, 0, 0},
		// --- Endulzantes ---
		{"Miel Pura de Abejas", "Alimentacion", "Endulzantes", "Miel", "litro",
			"Miel multifleural de montana, miel de bosque, miel de azahar.",
			"Pura",
			"https://images.unsplash.com/photo-1587049352846-4a222e784f38?auto=format&fit=crop&w=600&q=80", 3500, 50, 2000, 800, 650},
		{"Papelon y Panela", "Alimentacion", "Endulzantes", "Panela", "kg",
			"Papelon en bloque, panela granulada, rapadura, melaza de cana.",
			"De Cana",
			"https://images.unsplash.com/photo-1587049352846-4a222e784f38?auto=format&fit=crop&w=600&q=80", 800, 0, 0, 0, 0},
		// --- Carnes y Pescados ---
		{"Carnes de Pastoreo", "Alimentacion", "Carnes y Pescados", "Carnes", "kg",
			"Carne de res, cerdo criollo, pollo de patio, chivo, conejo, pato.",
			"Pastoreo Libre",
			"https://images.unsplash.com/photo-1607623814025-e3df5d8d6e1e?auto=format&fit=crop&w=600&q=80", 1200, 0, 0, 0, 0},
		{"Pescados y Mariscos", "Alimentacion", "Carnes y Pescados", "Pescados", "kg",
			"Pescado fresco de rio, pescado salado, carite, cazon, camarones, cangrejo.",
			"Del Rio/Mar",
			"https://images.unsplash.com/photo-1535140728325-a4d3707eee61?auto=format&fit=crop&w=600&q=80", 1000, 0, 0, 0, 0},
		{"Huevos Frescos", "Alimentacion", "Carnes y Pescados", "Huevos", "docena",
			"Huevos de gallina criolla, huevos de pato, huevos de codorniz.",
			"De Patio",
			"https://images.unsplash.com/photo-1569288063648-8a3d4f5e2f4e?auto=format&fit=crop&w=600&q=80", 600, 0, 0, 0, 0},
		// --- Bebidas ---
		{"Bebidas Fermentadas", "Alimentacion", "Bebidas", "Fermentadas", "litro",
			"Chicha de maiz, guarapo de cana, vino de palma, pulque, kombucha artesanal.",
			"Fermentacion Natural",
			"https://images.unsplash.com/photo-1544145945-f90425340c7e?auto=format&fit=crop&w=600&q=80", 500, 0, 0, 0, 0},
		{"Infusiones y Tes", "Alimentacion", "Bebidas", "Infusiones", "kg",
			"Te de hierbas, manzanilla, anis, tilo, boldo, hierbabuena seca.",
			"Botica Natural",
			"https://images.unsplash.com/photo-1597318181409-1e81af9b8d3e?auto=format&fit=crop&w=600&q=80", 100, 0, 0, 0, 0},
		// --- Condimentos ---
		{"Especias y Condimentos", "Alimentacion", "Condimentos", "Especias", "kg",
			"Comino, oregano, pimienta, aji dulce, aji picante, onoto, cilantro seco, laurel.",
			"Sazon Criolla",
			"https://images.unsplash.com/photo-1596040033229-a3c5b59a5c21?auto=format&fit=crop&w=600&q=80", 600, 0, 0, 0, 0},
		{"Aceites y Vinagres", "Alimentacion", "Condimentos", "Aceites", "litro",
			"Aceite de coco, aceite de ajonjoli, aceite de palma, vinagre de cana, vinagre de frutas.",
			"Prensado en Frio",
			"https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?auto=format&fit=crop&w=600&q=80", 1500, 0, 0, 0, 0},

		// ============ AGRICULTURA ============
		// --- Semillas y Plantulas ---
		{"Plantulas Medicinales y Aromaticas", "Agricultura", "Semillas y Plantulas", "Plantulas Medicinales", "maceta",
			"Poleo, estevia, malojillo, romero, ruda, oregano orejon, sabila, llanten, calendula.",
			"Para tu Huerto",
		...
		{"Semillas Criollas Adaptadas", "Agricultura", "Semillas y Plantulas", "Semillas", "sobre",
			"Semillas de maiz, frijol, caraota, ahuyama, tomate, pimenton, lechuga, cilantro.",
			"Semilla Nativa",
			"https://images.unsplash.com/photo-1576045057995-568f588f82fb?auto=format&fit=crop&w=600&q=80", 30, 0, 0, 0, 0},
		{"Estacas y Esquejes", "Agricultura", "Semillas y Plantulas", "Estacas", "unidad",
			"Estacas de yuca, platano, frutales (mango, aguacate, citricos), mora, parchita.",
			"Propagacion",
			"https://images.unsplash.com/photo-1576045057995-568f588f82fb?auto=format&fit=crop&w=600&q=80", 20, 0, 0, 0, 0},
		// --- Insumos Agricolas ---
		{"Abonos Organicos", "Agricultura", "Insumos Agricolas", "Abonos", "saco",
			"Compost maduro, humus de lombriz, estiercol curado, bokashi, gallinaza.",
			"Fertilidad Natural",
			"https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=600&q=80", 100, 0, 0, 0, 0},
		{"Bioinsumos y Preparados", "Agricultura", "Insumos Agricolas", "Bioinsumos", "litro",
			"Biofertilizantes, biopreparados fungicos, te de compost, purines, microorganismos eficientes.",
			"Agroecologia",
			"https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=600&q=80", 150, 0, 0, 0, 0},
		// --- Tierra y Compost ---
		{"Tierra Fertil y Sustratos", "Agricultura", "Tierra y Compost", "Sustratos", "saco",
			"Tierra preparada, sustrato para semilleros, turba, arena de rio, mezcla para macetas.",
			"Tierra Viva",
			"https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=600&q=80", 40, 0, 0, 0, 0},
		// --- Riego ---
		{"Sistemas de Riego", "Agricultura", "Riego", "Sistemas", "juego",
			"Mangueras, aspersores, goteros, bombas manuales, tanques de almacenamiento.",
			"Riego Eficiente",
			"https://images.unsplash.com/photo-1576045057995-568f588f82fb?auto=format&fit=crop&w=600&q=80", 500, 0, 0, 0, 0},

		// ============ SALUD Y MEDICINA ============
		// --- Medicina Botanica ---
		{"Tinturas Madres y Botica Conuquera", "Salud y Medicina", "Medicina Botanica", "Tinturas", "frasco",
			"Extractos de propoleo, tinturas de moringa, curcuma, jengibre, pomadas de arnica, jarabes naturales.",
			"100% Puro",
			"https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?auto=format&fit=crop&w=600&q=80", 1200, 0, 0, 0, 0},
		{"Cosmetica Natural sin Quimicos", "Salud y Medicina", "Medicina Botanica", "Cosmetica", "unidad",
			"Desodorantes de coco, balsamos labiales de cera de abeja, jabones artesanales, cremas de calendula.",
			"Residuo Cero",
			"https://images.unsplash.com/photo-1556228720-195a672e8a03?auto=format&fit=crop&w=600&q=80", 800, 0, 0, 0, 0},
		{"Hierbas Medicinales Secas", "Salud y Medicina", "Medicina Botanica", "Hierbas Secas", "kg",
			"Manzanilla, toronjil, valeriana, eucalipto, llanten, malojillo, sauco, tila deshidratados.",
			"Secado al Sol",
			"https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?auto=format&fit=crop&w=600&q=80", 400, 0, 0, 0, 0},
		// --- Terapias ---
		{"Terapias Manuales y Alternativas", "Salud y Medicina", "Terapias", "Sesiones", "sesion",
			"Masaje terapeutico, acupuntura, reflexologia, terapia manual, osteopatia, digitopuntura.",
			"Salud Integral",
			"https://images.unsplash.com/photo-1544161515-4ab6ce7db09c?auto=format&fit=crop&w=600&q=80", 650, 0, 0, 0, 0},
		// --- Higiene ---
		{"Jabones y Productos de Higiene", "Salud y Medicina", "Higiene", "Jabones", "unidad",
			"Jabon de lavar, jabon corporal natural, champu solido, dentifrico natural.",
			"Limpieza Natural",
			"https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?auto=format&fit=crop&w=600&q=80", 300, 0, 0, 0, 0},
		{"Detergentes y Suavizantes Naturales", "Salud y Medicina", "Higiene", "Detergentes", "litro",
			"Detergente biodegradable, suavizante de plantas, limpiador multiusos, desinfectante natural.",
			"Eco Limpieza",
			"https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?auto=format&fit=crop&w=600&q=80", 400, 0, 0, 0, 0},
		// --- Primeros Auxilios ---
		{"Botiquin y Primeros Auxilios", "Salud y Medicina", "Primeros Auxilios", "Botiquin", "juego",
			"Vendas, gasas, alcohol, yodo, apositos, tiritas, tijeras, manual de primeros auxilios.",
			"Emergencia",
			"https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?auto=format&fit=crop&w=600&q=80", 500, 0, 0, 0, 0},

		// ============ TEXTILES ============
		// --- Confeccion ---
		{"Prendas de Vestir Artesanales", "Textiles", "Confeccion", "Prendas", "unidad",
			"Camisas, pantalones, vestidos, faldas, blusas, ropa interior de algodon de lana o algodon.",
			"Hecho a Mano",
			"https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=600&q=80", 4200, 100, 3000, 800, 300},
		{"Reparacion y Adaptacion de Prendas", "Textiles", "Confeccion", "Reparaciones", "prenda",
			"Parches, costuras, ajustes, dobladillos, cambio de cremalleras, reformas.",
			"Reutilizar",
			"https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=600&q=80", 500, 0, 0, 0, 0},
		// --- Tejidos ---
		{"Telas Naturales", "Textiles", "Tejidos", "Telas", "m",
			"Tela de algodon, lino, lana, cañamo, tela cruda, tela teñida natural.",
			"Natural",
			"https://images.unsplash.com/photo-1605000797499-95a51c5269ae?auto=format&fit=crop&w=600&q=80", 1500, 50, 800, 500, 150},
		{"Cobijas, Frazadas y Hamacas", "Textiles", "Tejidos", "Cobijas", "unidad",
			"Frazadas de lana, mantas de algodon, hamacas de cañamo, colchas tejidas.",
			"Calor Artesanal",
			"https://images.unsplash.com/photo-1605000797499-95a51c5269ae?auto=format&fit=crop&w=600&q=80", 6000, 0, 0, 0, 0},
		// --- Hilos y Materiales ---
		{"Hilos y Lana para Tejer", "Textiles", "Hilos y Materiales", "Hilos", "rollo",
			"Hilo de coser, lana para tejer, hilo de cañamo, estambres, hilos encerados.",
			"Materia Prima",
			"https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=600&q=80", 200, 0, 0, 0, 0},

		// ============ ARTESANIA ============
		// --- Ceramica ---
		{"Vasijas y Vajilla de Barro", "Artesania", "Ceramica", "Vasijas", "unidad",
			"Ollas de barro, vasijas, platos, tazas, cantaras, budares de arcilla.",
			"Barro Artesanal",
			"https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?auto=format&fit=crop&w=600&q=80", 2500, 0, 0, 0, 0},
		{"Ceramica Decorativa", "Artesania", "Ceramica", "Decoracion", "unidad",
			"Figuras, adornos, macetas decorativas, joyeros de arcilla.",
			"Hecho a Mano",
			"https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?auto=format&fit=crop&w=600&q=80", 3000, 0, 0, 0, 0},
		// --- Cesteria ---
		{"Canastas y Cesteria", "Artesania", "Cesteria", "Canastas", "unidad",
			"Canastos, cestas, petacas, cajas de fibra vegetal, sombreros de paja.",
			"Fibra Vegetal",
			"https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?auto=format&fit=crop&w=600&q=80", 1800, 0, 0, 0, 0},
		// --- Madera ---
		{"Tallados y Utensilios de Madera", "Artesania", "Madera", "Tallados", "unidad",
			"Cucharas de palo, morteros, pilones, tallas decorativas, juguetes de madera.",
			"Madera Noble",
			"https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?auto=format&fit=crop&w=600&q=80", 3500, 0, 0, 0, 0},
		{"Muebles Rusticos de Madera", "Artesania", "Madera", "Muebles", "unidad",
			"Mesas, sillas, bancos, camas, estantes, muebles rusticos de madera local.",
			"Muebleria Artesanal",
			"https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?auto=format&fit=crop&w=600&q=80", 15000, 0, 0, 0, 0},

		// ============ SERVICIOS ============
		// --- Trabajo Agricola ---
		{"Jornal Agricola", "Servicios", "Trabajo Agricola", "Jornales", "hora",
			"Siembra, cosecha, limpieza, riego, desmalece, preparacion de tierra.",
			"Conuquero",
			"https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=600&q=80", 325, 0, 325, 0, 0},
		// --- Construccion ---
		{"Albanileria y Obra Menor", "Servicios", "Construccion", "Albanileria", "hora",
			"Mamposteria, repello, acabados, levantamiento de paredes, bahareque, adobe.",
			"Constructor",
			"https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=600&q=80", 350, 0, 0, 0, 0},
		{"Carpinteria y Ebanisteria", "Servicios", "Construccion", "Carpinteria", "hora",
			"Puertas, ventanas, muebles a medida, reparacion de estructuras de madera.",
			"Carpintero",
			"https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=600&q=80", 400, 0, 0, 0, 0},
		// --- Reparaciones ---
		{"Mecanica General", "Servicios", "Reparaciones", "Mecanica", "hora",
			"Reparacion de motores, bicicletas, motos, maquinas agricolas, bombas de agua.",
			"Mecanico",
			"https://images.unsplash.com/photo-1632823469850-1e6a3d1c14e1?auto=format&fit=crop&w=600&q=80", 400, 0, 0, 0, 0},
		{"Electricidad y Electrotecnia", "Servicios", "Reparaciones", "Electricidad", "hora",
			"Instalaciones electricas, reparaciones, cableado, paneles solares, baterias.",
			"Electricista",
			"https://images.unsplash.com/photo-1632823469850-1e6a3d1c14e1?auto=format&fit=crop&w=600&q=80", 450, 0, 0, 0, 0},
		{"Plomeria y Fontaneria", "Servicios", "Reparaciones", "Plomeria", "hora",
			"Reparacion de tuberias, filtros de agua, tanques, baños, instalaciones sanitarias.",
			"Plomero",
			"https://images.unsplash.com/photo-1632823469850-1e6a3d1c14e1?auto=format&fit=crop&w=600&q=80", 400, 0, 0, 0, 0},
		// --- Transporte ---
		{"Transporte de Carga", "Servicios", "Transporte", "Carga", "viaje",
			"Transporte de mercancia, materiales, cosechas dentro y fuera de la comunidad.",
			"Traslado",
			"https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=600&q=80", 200, 0, 0, 0, 0},
		{"Pasaje de Personas", "Servicios", "Transporte", "Pasaje", "viaje",
			"Transporte de personas al pueblo, centro medico, mercado, gestiones.",
			"Viaje",
			"https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=600&q=80", 50, 0, 0, 0, 0},
		// --- Educacion ---
		{"Clases y Tutorias", "Servicios", "Educacion", "Clases", "hora",
			"Alfabetizacion, matematicas, oficios, idiomas, lectura, escritura.",
			"Enseñanza",
			"https://images.unsplash.com/photo-1503676263721-6a1f61fcacd6?auto=format&fit=crop&w=600&q=80", 300, 0, 0, 0, 0},
		// --- Limpieza ---
		{"Limpieza de Espacios", "Servicios", "Limpieza", "General", "hora",
			"Limpieza de espacios comunes, casas, talleres, desinfeccion, orden.",
			"Aseo",
			"https://images.unsplash.com/photo-1581578731548-cba46ace809f?auto=format&fit=crop&w=600&q=80", 250, 0, 0, 0, 0},
		// --- Salud ---
		{"Consulta Medica y Odontologica", "Servicios", "Salud", "Consulta", "sesion",
			"Consulta medica general, odontologia basica, vacunacion, control prenatal, veterinaria.",
			"Atencion",
			"https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=600&q=80", 650, 0, 0, 0, 0},
		// --- Oficina ---
		{"Trabajo Administrativo y Gestion", "Servicios", "Oficina", "Administrativo", "hora",
			"Contabilidad, gestion documental, tramites, redaccion de cartas, gestion comunitaria.",
			"Gestion",
			"https://images.unsplash.com/photo-1503676263721-6a1f61fcacd6?auto=format&fit=crop&w=600&q=80", 300, 0, 0, 0, 0},
		...
		{"Bloques, Adobe y Bahareque", "Construccion", "Materiales", "Adobe", "unidad",
			"Bloques de tierra comprimida, adobes, bahareque, ladrillos de barro.",
			"Construccion Natural",
			"https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=600&q=80", 150, 0, 0, 0, 0},
		{"Madera de Construccion", "Construccion", "Materiales", "Madera", "m",
			"Madera aserrada, vigas, tablas, latas, listones de madera local.",
			"Estructura",
			"https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=600&q=80", 800, 0, 0, 0, 0},
		{"Piedra y Agregados", "Construccion", "Materiales", "Piedra", "m3",
			"Piedra de rio, grava, arena, cascajo, material de relleno.",
			"Base Solida",
			"https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=600&q=80", 300, 0, 0, 0, 0},
		// --- Acabados ---
		{"Pinturas y Recubrimientos Naturales", "Construccion", "Acabados", "Pintura", "litro",
			"Pintura a cal, tierra pigmentada, estucos naturales, impermeabilizantes.",
			"Acabado Natural",
			"https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=600&q=80", 500, 0, 0, 0, 0},

		// ============ ENERGIA ============
		// --- Solar ---
		{"Sistemas Solares Pequenos", "Energia", "Solar", "Sistemas", "juego",
			"Paneles solares pequenos, baterias, controladores, inversores basicos.",
			"Energia Limpia",
			"https://images.unsplash.com/photo-1509391366360-2e959784a276?auto=format&fit=crop&w=600&q=80", 5000, 0, 0, 0, 0},
		{"Mantenimiento de Sistemas Solares", "Energia", "Solar", "Mantenimiento", "hora",
			"Limpieza de paneles, ajuste, revision de baterias, cableado, inversores.",
			"Mantencion",
			"https://images.unsplash.com/photo-1509391366360-2e959784a276?auto=format&fit=crop&w=600&q=80", 400, 0, 0, 0, 0},
		// --- Lena ---
		{"Lena Seca para Cocinar", "Energia", "Lena", "Lena", "atado",
			"Lena seca de arboles frutales y de sombra, lista para cocinar y calentar.",
			"Fuego Natural",
			"https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=600&q=80", 80, 0, 0, 0, 0},
		{"Carbon Vegetal", "Energia", "Lena", "Carbon", "saco",
			"Carbon vegetal de hornos artesanales para cocina y fundicion.",
			"Carbon Artesanal",
			"https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=600&q=80", 300, 0, 0, 0, 0},

		// ============ HERRAMIENTAS ============
		// --- Manuales ---
		{"Herramientas de Campo", "Herramientas", "Manuales", "Agricolas", "unidad",
			"Machetes, palas, picos, rastrillos, azadones, guadañas, horquillas, regaderas.",
			"Trabajo Duro",
			"https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=600&q=80", 2000, 0, 0, 0, 0},
		{"Herramientas de Taller", "Herramientas", "Manuales", "Taller", "unidad",
			"Martillos, serruchos, limas, destornilladores, alicates, llaves, tornillos de banco.",
			"Taller",
			"https://images.unsplash.com/photo-1632823469850-1e6a3d1c14e1?auto=format&fit=crop&w=600&q=80", 2000, 0, 0, 0, 0},
		{"Afilar y Mantener Herramientas", "Herramientas", "Manuales", "Mantenimiento", "unidad",
			"Afilado de machetes, cuchillos, tijeras, reparacion de mangos.",
			"Mantencion",
			"https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=600&q=80", 200, 0, 0, 0, 0},
		// --- Electricas ---
		{"Equipos Electricos de Taller", "Herramientas", "Electricas", "Equipos", "unidad",
			"Taladros, sierras circulares, amoladoras, lijadoras, soldadoras portatiles.",
			"Electrico",
			"https://images.unsplash.com/photo-1632823469850-1e6a3d1c14e1?auto=format&fit=crop&w=600&q=80", 8000, 0, 0, 0, 0},

		// ============ TECNOLOGIA ============
		// --- Computacion ---
		{"Reparacion de Computadoras", "Tecnologia", "Computacion", "Reparacion", "hora",
			"Reparacion de hardware, limpieza, cambio de piezas, instalacion de software.",
			"Soporte Tecnico",
			"https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=600&q=80", 500, 0, 0, 0, 0},
		{"Mantenimiento y Software", "Tecnologia", "Computacion", "Mantenimiento", "hora",
			"Limpieza de virus, instalacion de programas, configuracion, respaldos.",
			"Software",
			"https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=600&q=80", 300, 0, 0, 0, 0},
		// --- Electrodomesticos ---
		{"Reparacion de Electrodomesticos", "Tecnologia", "Electrodomesticos", "Reparacion", "hora",
			"Reparacion de neveras, licuadoras, cocinas, lavadoras, ventiladores, planchas.",
			"Reparacion",
			"https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=600&q=80", 450, 0, 0, 0, 0},
		// --- Telefonos ---
		{"Reparacion de Telefonos", "Tecnologia", "Telefonos", "Reparacion", "hora",
			"Cambio de pantallas, baterias, cristales, microfonos, conectores de carga.",
			"Movil",
			"https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=600&q=80", 400, 0, 0, 0, 0},
		// --- Componentes ---
		{"Componentes Electronicos", "Tecnologia", "Componentes", "Piezas", "lote",
			"Resistencias, capacitores, cables, conectores, soldadura, plaquetas, fusibles.",
			"Electronica",
			"https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=600&q=80", 300, 0, 0, 0, 0},

		// ============ TRANSPORTE ============
		// --- Vehiculos ---
		{"Bicicletas y Refacciones", "Transporte", "Vehiculos", "Bicicletas", "unidad",
			"Bicicletas, llantas, cadenas, frenos, asientos, luces, canastos.",
			"Transporte Limpio",
			"https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=600&q=80", 8000, 0, 0, 0, 0},
		{"Mantenimiento de Vehiculos", "Transporte", "Vehiculos", "Mantenimiento", "hora",
			"Ajustes, lubricacion, cambio de aceites, frenos, revision general.",
			"Mantencion",
			"https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=600&q=80", 350, 0, 0, 0, 0},
		// --- Animales ---
		{"Animales de Carga y Montura", "Transporte", "Animales", "Equinos", "unidad",
			"Caballos, burros, mulas para carga, montura y trabajo agricola.",
			"Traccion Animal",
			"https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=600&q=80", 15000, 0, 0, 0, 0},
		{"Servicio de Arriero", "Transporte", "Animales", "Arriero", "jornada",
			"Transporte de carga con animal, conduccion de ganado, traslado de mercancia.",
			"A Caballo",
			"https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=600&q=80", 2600, 0, 0, 0, 0},

		// ============ CULTURA ============
		// --- Musica ---
		{"Instrumentos Musicales Artesanales", "Cultura", "Musica", "Instrumentos", "unidad",
			"Tambores, maracas, cuatros, guitarras, marimbas, flautas de cana.",
			"Musica Viva",
			"https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=600&q=80", 5000, 0, 0, 0, 0},
		{"Clases de Musica", "Cultura", "Musica", "Clases", "hora",
			"Enseñanza de cuatro, guitarra, percusion, canto, teoria musical.",
			"Enseñanza",
			"https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=600&q=80", 300, 0, 0, 0, 0},
		// --- Eventos ---
		{"Animacion y Cuentacuentos", "Cultura", "Eventos", "Animacion", "hora",
			"Animacion de fiestas, cuentacuentos, teatro comunitario, payasos.",
			"Fiesta",
			"https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=600&q=80", 500, 0, 0, 0, 0},
		// --- Artes ---
		{"Pintura y Artes Visuales", "Cultura", "Artes", "Pintura", "unidad",
			"Cuadros, murales, retratos, artesania decorativa, cartelera.",
			"Arte",
			"https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=600&q=80", 2500, 0, 0, 0, 0},

		// ============ EDUCACION ============
		// --- Talleres ---
		{"Talleres de Oficios", "Educacion", "Talleres", "Oficios", "hora",
			"Carpinteria, costura, cocina, mecanica, electricidad, albanileria.",
			"Aprender Haciendo",
			"https://images.unsplash.com/photo-1503676263721-6a1f61fcacd6?auto=format&fit=crop&w=600&q=80", 300, 0, 0, 0, 0},
		{"Talleres de Agroecologia", "Educacion", "Talleres", "Agricultura", "hora",
			"Permacultura, agroecologia, huertos urbanos, conservacion de semillas, compostaje.",
			"Conuco",
			"https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=600&q=80", 300, 0, 0, 0, 0},
		{"Talleres de Salud Comunitaria", "Educacion", "Talleres", "Salud", "hora",
			"Primeros auxilios, medicina natural, nutricion, prevencion, salud reproductiva.",
			"Salud",
			"https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=600&q=80", 300, 0, 0, 0, 0},
		// --- Alfabetizacion ---
		{"Alfabetizacion y Educacion Basica", "Educacion", "Alfabetizacion", "Basica", "hora",
			"Lectura, escritura, matematicas basicas, educacion primaria para adultos.",
			"Aprender",
			"https://images.unsplash.com/photo-1503676263721-6a1f61fcacd6?auto=format&fit=crop&w=600&q=80", 300, 0, 0, 0, 0},
	}
