...
INSERT INTO users (id, node_domain, username, display_name, account_type, membership_status, balance, credit_limit, debit_limit, is_active)
SELECT gen_random_uuid(), 'localhost', 'fondo_comunitario', 'Fondo Comunitario', 'fund', 'active', 0, 0, 999999999, true
...
INSERT INTO users (id, node_domain, username, display_name, account_type, membership_status, balance, credit_limit, debit_limit, is_active)
SELECT gen_random_uuid(), 'localhost', 'impuestos', 'Cuenta de Impuestos', 'fund', 'active', 0, 0, 999999999, true
