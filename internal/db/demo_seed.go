...
func getRaicesDelMontePages() []seedPage {
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "image_url": "https://images.unsplash.com/photo-1509444154694-2c20049b1c1e?auto=format&fit=crop&w=1000&q=80",
        "title": "Pan de Quinua",
			...
			Content: `[
  {
    ...
    "image_url": "https://images.unsplash.com/photo-1469594292607-9bd787ad1f7d?auto=format&fit=crop&w=1200&q=80",
    "style": "split"
  },
  {
    "type": "split_story",
    ...
    "image_url": "https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?auto=format&fit=crop&w=1000&q=80",
    "image_position": "left",
    "highlights": [
			...
			Content: `[
  {
    ...
    "image_url": "https://images.unsplash.com/photo-1416879595882-3373a0480b5f?auto=format&fit=crop&w=1200&q=80",
    "style": "split"
  },
  {
    "type": "split_story",
			...
			Content: `[
  {
    ...
    "image_url": "https://images.unsplash.com/photo-1503676263500-dc4d0b59d4df?auto=format&fit=crop&w=1200&q=80",
    "style": "split"
  },
  {
    "type": "features_grid",
			...
			Content: `[
  {
    ...
    "image_url": "https://images.unsplash.com/photo-1463249035-39d7d217e5b9?auto=format&fit=crop&w=1200&q=80",
    "style": "split"
  },
  {
    "type": "features_grid",
			...
			Content: `[
  {
    ...
    "image_url": "https://images.unsplash.com/photo-1532009877182-46d5c9231e51?auto=format&fit=crop&w=1200&q=80",
    "style": "standard"
  },
  {
    "type": "features_grid",
...
func demoSeedProducts(ctx context.Context, d *DB, nodeDomain string) error {
	...
	products := []struct {
		...
		{"Agricultura", "Cultivos", "Granos", "Frijol negro de altura (1kg)", "kg", "Frijol negro cultivado a 1200m, secado al sol", "organico", "https://images.unsplash.com/photo-1515543237350-bf1b67e41be3?auto=format&fit=crop&w=600&q=80", 35},
		{"Agricultura", "Cultivos", "Granos", "Quinua andina (1kg)", "kg", "Quinua cultivada en bancales de montana", "nativo", "https://images.unsplash.com/photo-1564093497595-593b129d4143?auto=format&fit=crop&w=600&q=80", 45},
		{"Agricultura", "Cultivos", "Hortalizas", "Tomate de huerto (1kg)", "kg", "Tomate perita de cultivo agroecologico", "fresco", "https://images.unsplash.com/photo-1546470427-e26264be0b0d?auto=format&fit=crop&w=600&q=80", 25},
		{"Agricultura", "Cultivos", "Hortalizas", "Lechuga de bancale", "unidad", "Lechuga batavia de bancal elevado", "fresco", "https://images.unsplash.com/photo-1622205313165-497e3f53e31c?auto=format&fit=crop&w=600&q=80", 15},
		{"Agricultura", "Cultivos", "Raices", "Ocumo de montana (1kg)", "kg", "Ocumo nativo de sombra", "nativo", "https://images.unsplash.com/photo-1607305387299-a3d96abfd2a8?auto=format&fit=crop&w=600&q=80", 20},
		{"Agricultura", "Cultivos", "Frutas", "Guayaba de rio (1kg)", "kg", "Guayaba de arboles a orillas del arroyo", "temporal", "https://images.unsplash.com/photo-1605000797499-95a51c5269ae?auto=format&fit=crop&w=600&q=80", 22},
		{"Agricultura", "Cultivos", "Frutas", "Mora de monte (500g)", "paquete", "Mora silvestre recolectada en el bosque", "silvestre", "https://images.unsplash.com/photo-1490477359199-29529uflack?auto=format&fit=crop&w=600&q=80", 30},

		// Derivados artesanales
		{"Alimentacion", "Derivados", "Lacteos", "Queso de cabra (500g)", "unidad", "Queso fresco de cabras lecheras", "artesanal", "https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?auto=format&fit=crop&w=600&q=80", 60},
		{"Alimentacion", "Derivados", "Panaderia", "Pan de quinua (1kg)", "kg", "Pan integral hecho con harina de quinua del huerto", "artesanal", "https://images.unsplash.com/photo-1509444154694-2c20049b1c1e?auto=format&fit=crop&w=600&q=80", 50},
		{"Alimentacion", "Derivados", "Conservas", "Mermelada de mora", "frasco", "Mermelada artesanal de mora de monte", "artesanal", "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=600&q=80", 40},
		{"Alimentacion", "Derivados", "Miel", "Miel de montana (250ml)", "frasco", "Miel pura de abejas nativas sin agroticos", "natural", "https://images.unsplash.com/photo-1587049352846-cf289f7c4b52?auto=format&fit=crop&w=600&q=80", 70},

		// Artesania local
		{"Artesania", "Textiles", "Tejidos", "Ruana de lana (unidad)", "unidad", "Ruana tejida a mano con lana de ovejas de la comunidad", "artesanal", "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=600&q=80", 250},
		{"Artesania", "Ceramica", "Vajilla", "Set 4 cuencos de barro", "set", "Cuencos de barro cocido hechos con arcilla local", "artesanal", "https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?auto=format&fit=crop&w=600&q=80", 150},
		{"Artesania", "Madera", "Muebles", "Banco de madera de cedro", "unidad", "Banco rustico de cedro del bosque comunitario", "artesanal", "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=600&q=80", 300},
		{"Artesania", "Cesteria", "Cestas", "Cesta de bambu (mediana)", "unidad", "Cesta tejida con bambu del bosque", "artesanal", "https://images.unsplash.com/photo-1595590424283-b8f17842773f?auto=format&fit=crop&w=600&q=80", 80},
		...
		// Salud natural
		{"Salud y Medicina", "Natural", "Hierbas", "Te de hierbas del monte (100g)", "paquete", "Mezcla de hierbas medicinales del bosque: toronjil, malojillo, llanten", "natural", "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?auto=format&fit=crop&w=600&q=80", 25},
	...
	compositeProducts := []struct {
		...
		{"Alimentacion", "Compuestos", "Cocina", "Kit de Mermelada Artesanal (3 frascos)", "kit", "Set de 3 mermeladas artesanales: mora, guayaba y tomate. Incluye envases de vidrio retornables.", "Compuesto", "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=600&q=80", 150},
		{"Alimentacion", "Compuestos", "Cocina", "Cesta de Desayuno de Montaña", "cesta", "Cesta con pan de quinua, miel, queso de cabra y te de hierbas. Para 4 personas.", "Compuesto", "https://images.unsplash.com/photo-1509444154694-2c20049b1c1e?auto=format&fit=crop&w=600&q=80", 220},
		{"Agricultura", "Compuestos", "Semillas", "Banco de Semillas Criollas (10 variedades)", "set", "Coleccion de 10 semillas criollas: frijol, quinua, tomate, lechuga, ocumo, guayaba, mora, ají, cilantro, calabaza.", "Compuesto", "https://images.unsplash.com/photo-1463249035-39d7d217e5b9?auto=format&fit=crop&w=600&q=80", 180},
		{"Artesania", "Compuestos", "Vajilla", "Vajilla de Barro (4 personas)", "set", "Set completo: 4 platos, 4 cuencos, 4 tazas de barro cocido artesanal.", "Compuesto", "https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?auto=format&fit=crop&w=600&q=80", 400},
		{"Salud y Medicina", "Compuestos", "Botiquin", "Botiquin Natural de Montaña", "botiquin", "Set de remedios naturales: te de hierbas, aceite de romero, miel medicinal, cataplasma de llanten.", "Compuesto", "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?auto=format&fit=crop&w=600&q=80", 130},
		{"Herramientas", "Compuestos", "Kits", "Kit de Huerto Familiar", "kit", "Kit completo: azadon, tijeras de podar, semillas, abono organico y manual de agroecologia.", "Compuesto", "https://images.unsplash.com/photo-1416879595882-3373a0480b5f?auto=format&fit=crop&w=600&q=80", 280},
		{"Servicios", "Compuestos", "Talleres", "Programa de Formacion Comunitaria", "programa", "Paquete educativo: curso de agroecologia (8 sesiones) + taller de permacultura + taller de medicina natural.", "Compuesto", "https://images.unsplash.com/photo-1503676263500-dc4d0b59d4df?auto=format&fit=crop&w=600&q=80", 800},
		{"Construccion", "Compuestos", "Natural", "Kit de Construccion con Barro y Paja", "kit", "Materiales y herramientas para construccion natural: barro, paja, madera, mano de obra (2 jornadas).", "Compuesto", "https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?auto=format&fit=crop&w=600&q=80", 450},
	}
